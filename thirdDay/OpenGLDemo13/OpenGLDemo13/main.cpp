...
void MakePyramid(GLBatch& pyramidBatch){
    ...
    //参数2:s坐标
    //参数3:t坐标
    pyramidBatch.MultiTexCoord2f(0.0f, 0.0f, 0.0f);
    //设置顶点坐标
    ...
    pyramidBatch.Normal3f(0.0f, -1.0f, 0.0f);
    //设置顶点对应的纹理坐标
    pyramidBatch.MultiTexCoord2f(0.0f, 1.0f, 0.0f);
    //设置顶点坐标
    pyramidBatch.Vertex3f(1.0f, -1.0f, -1.0f);
    ...
    pyramidBatch.Normal3f(0.0f, -1.0f, 0.0f);
    //设置顶点对应的纹理坐标
    pyramidBatch.MultiTexCoord2f(0.0f, 1.0f, 1.0f);
    //设置顶点坐标
    pyramidBatch.Vertex3f(1.0f, -1.0f, 1.0f);
    ...
    //参数2:s坐标
    //参数3:t坐标
    pyramidBatch.MultiTexCoord2f(0.0f, 0.0f, 1.0f);
    //设置顶点坐标
    pyramidBatch.Vertex3f(-1.0f, -1.0f, 1.0f);
    ...
    pyramidBatch.Normal3fv(n);
    //设置顶点对应的纹理坐标
    pyramidBatch.MultiTexCoord2f(0, 1, 0);
    //设置顶点坐标
...
void display(){
    ...
    //    shaderManager.UseStockShader(GLT_SHADER_TEXTURE_POINT_LIGHT_DIFF,transformPipeline.GetModelViewProjectionMatrix(),vLightPos,vWhite,0);
